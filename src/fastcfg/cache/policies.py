...
Attributes:
    TEN_MIN_TTL (TTLCacheStrategy): A TTL (Time-To-Live) cache strategy with a duration of 10 minutes.
    ...
    LRU_POLICY (LRUCacheStrategy): A Least Recently Used (LRU) cache strategy with a default capacity of 100 entries.
